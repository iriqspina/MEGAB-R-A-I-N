...
PLANO: list[tuple[str, str, str, str]] = [
    ...
    # executaveis
    ("mover", "09_abrir-kimi-visual.cmd", "scripts/09_abrir-kimi-visual.cmd", "executavel sai da raiz"),
    ("mover", "07_instalar-identidade.cmd", "scripts/07_instalar-identidade.cmd", "executavel sai da raiz"),
    ("mover", "10_publicar-e-fotografar.cmd", "scripts/10_publicar-e-fotografar.cmd", "executavel sai da raiz"),
    ("mover", "06_sincronizar-identidade.cmd", "scripts/06_sincronizar-identidade.cmd", "executavel sai da raiz"),
    ("mover", "08_refresh-plugin-kimi.cmd", "scripts/08_refresh-plugin-kimi.cmd", "executavel sai da raiz"),
    ("mover", "11_enviar-pro-github.cmd", "scripts/11_enviar-pro-github.cmd", "executavel sai da raiz"),
    ("mover", "04_novo-projeto.cmd", "scripts/04_novo-projeto.cmd", "executavel sai da raiz"),
    ("mover", "05_sincronizar-projetos.cmd", "scripts/05_sincronizar-projetos.cmd", "executavel sai da raiz"),
...
PATCHES: list[tuple[str, str, str]] = [
    ("scripts/07_instalar-identidade.cmd", '%~dp0260810_memoria-pessoal.md', '%~dp0..\\260810_memoria-pessoal.md'),
    ("scripts/07_instalar-identidade.cmd", '%~dp0bin\\', '%~dp0..\\bin\\'),
    ("scripts/06_sincronizar-identidade.cmd", 'set "MB=%~dp0"', 'set "MB=%~dp0..\\"'),
    ("scripts/10_publicar-e-fotografar.cmd", '%~dp0_github/export', '%~dp0..\\_github/export'),
    ("scripts/10_publicar-e-fotografar.cmd", '%~dp0_github/repo-local', '%~dp0..\\_github/repo-local'),
    ("scripts/10_publicar-e-fotografar.cmd", '%~dp0bin\\', '%~dp0..\\bin\\'),
    ("scripts/10_publicar-e-fotografar.cmd", '%~dp0VERSAO.txt', '%~dp0..\\VERSAO.txt'),
    ("scripts/11_enviar-pro-github.cmd", 'set "RAIZ=%~dp0"', 'set "RAIZ=%~dp0..\\"'),
    ("scripts/04_novo-projeto.cmd", 'set "FONTE=%~dp0"', 'set "FONTE=%~dp0..\\"'),
    ("scripts/04_novo-projeto.cmd", 'set "CFG=%~dp0.mb-projetos.cmd"', 'set "CFG=%~dp0..\\.mb-projetos.cmd"'),
    ...
    ("MEGABRAIN.md", "5. Espalhar → `05_sincronizar-projetos.cmd`.", "5. Espalhar → `scripts/05_sincronizar-projetos.cmd`."),
    ("MEGABRAIN.md", "nível 1 (`04_novo-projeto.cmd`)", "nível 1 (`scripts/04_novo-projeto.cmd`)"),
    ("CHECKLIST-ABERTURA.md", "`05_sincronizar-projetos.cmd`", "`scripts/05_sincronizar-projetos.cmd`"),
    ("CHECKLIST-ABERTURA.md", "`06_sincronizar-identidade.cmd`", "`scripts/06_sincronizar-identidade.cmd`"),
    ("referencias/260818_padrao-resposta.md", "(`06_sincronizar-identidade.cmd`)", "(`scripts/06_sincronizar-identidade.cmd`)"),
    ("modelos/LEIAME-megabrain-do-projeto.txt", "rode 05_sincronizar-projetos.cmd lá", "rode scripts\\05_sincronizar-projetos.cmd lá"),
    ("HANDOFF.md", "Duplo\n   clique em `11_enviar-pro-github.cmd`", "Duplo\n   clique em `scripts/11_enviar-pro-github.cmd`"),
]
