...
robocopy "%FONTE%motor\skills\pet" "%DEST%\MEGABRAIN\skills\pet" /E /NFL /NDL /NJH /NJS >nul
robocopy "%FONTE%motor\skills\marcelinhopet" "%DEST%\MEGABRAIN\skills\marcelinhopet" /E /NFL /NDL /NJH /NJS >nul
